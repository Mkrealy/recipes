...
if($becipe_fn_pagetitle !== 'disable'){ 
	if(isset($becipe_fn_option['blog_single_title'])){
		$pageTitle = $becipe_fn_option['blog_single_title'];
	}
?>
<!-- PAGE TITLE -->
<div class="becipe_fn_pagetitle">
	<div class="title_holder">
		<?php echo $seo_page_title__start; ?><?php echo esc_html($pageTitle);?><?php echo $seo_page_title__end; ?>
	</div>
</div>
<!-- /PAGE TITLE -->
<?php } ?>
