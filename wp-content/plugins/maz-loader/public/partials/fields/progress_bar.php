...
?>
<div
	class="mazloader-item-percentage-counter mazloader-item-progress-bar mazloader-item-text pos_<?php echo esc_attr( $fieldData->get( 'position' ) ); ?><?php echo esc_attr(implode(' ', $field_classes)); ?>"
...
>
	<div <?php echo wp_kses_data($inner_style_atts); ?>>
		<div class="progress-bar-item-outer"<?php echo wp_kses_data($outer_bar_atts); ?>><div class="progress-bar-item"<?php echo wp_kses_data($bar_atts); ?>></div></div>
		<div class="mzldr-percentage-counter mzldr-progress-bar<?php echo esc_attr($percentage_counter_classes); ?>" data-duration="<?php echo esc_attr($data_duration); ?>">1</div>
	</div>
</div>