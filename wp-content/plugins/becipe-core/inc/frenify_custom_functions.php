...
$attchments_options = array(
	'image_video_url' => array(
        'label'       => __( 'External Video Url', 'becipe' ),
        'input'       => 'text',
        'helps'       => __( 'Url from Youtube or Vimeo', 'becipe' ),
        'application' => 'image',
        'exclusions'  => array( 'audio', 'video' ),
    ),
);

class Becipe_Custom_Media_Fields {
...
$cmf = new Becipe_Custom_Media_Fields( $attchments_options );
