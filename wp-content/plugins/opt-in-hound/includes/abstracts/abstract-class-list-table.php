 ...
 *
 */
abstract Class OIH_WP_List_Table {
...
<?php
	...
	protected function get_primary_column_name() {
		...
		if ( ! isset( $columns[ $default ] ) ) {
			$default = OIH_WP_List_Table::get_default_primary_column_name();
		}
...
?>
<table class="oih-wp-list-table <?php echo implode( ' ', $this->get_table_classes() ); ?>">
	<thead>
	<tr>
